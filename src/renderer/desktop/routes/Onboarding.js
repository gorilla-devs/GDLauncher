...
import BisectHosting from 'src/renderer/common/components/BisectHosting';
import { openModal } from 'src/renderer/common/reducers/modals/actions';
import GDAnimation from 'src/common/assets/onboarding.webm';
      ...
      >
        ...
        >
          <video
            ...
            `}
          >
            <source src={GDAnimation} type="video/webm" />
          </video>
        </div>
      </div>
      <div
