...
const ModpacksListWrapper = ({
  ...
  const Item = memo(({ index, style }) => {
    ...
    const primaryImage = modpack.background?.url;
    return (
      <div
          ...
          <div
            onClick={() => {
              setVersion({
                ...
                fileID: modpack.solder ? modpack.latest : modpack.version,
                source: modpack.solder ? TECHNIC_SOLDER : TECHNIC
              });
              setModpack({ ...modpack, name: modpack.displayName });
              setStep(1);
            }}
          >
            Download Latest
            ...
            onClick={() => {
              dispatch(
                openModal('ModpackDescription', {
                  ...
                  setModpack,
                  setStep,
                  type: modpack.solder ? TECHNIC_SOLDER : TECHNIC
                })
              );
            }}
          >
