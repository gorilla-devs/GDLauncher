...
export const UPDATE_CURSEFORGE_API_KEY = 'UPDATE_CURSEFORGE_API_KEY';
export const HIDE_CURSEFORGE_THIRD_PARTY_DOWNLOADS_NOTICE =
  'HIDE_CURSEFORGE_THIRD_PARTY_DOWNLOADS_NOTICE';
